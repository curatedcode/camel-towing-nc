export function GoogleLogoIcon(props: React.SVGAttributes<SVGElement>) {
	return (
		// biome-ignore lint/a11y/noSvgWithoutTitle: Handled by parent
		<svg
		...
		>
			...
			></path>
			<path fill="#2ab2db" d="M8.718 13.374z"></path>
			<path
				fill="#ea4435"
			...
			></path>
			<path fill="#2ab2db" d="M8.718 18.626z"></path>
			<path
				fill="#4285f4"
